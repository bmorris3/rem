...
# Image paths
image_paths = sorted(glob('/Users/brettmorris/git/tic224283342/data/minerva_20190817/MDwarf-*z45.fit'))[:94]
...
output_path = 'outputs/minerva_z1.npz'
...
np.save('outputs/minerva_z1.npy', np.vstack([phot_results.times, best_lc]).T)
