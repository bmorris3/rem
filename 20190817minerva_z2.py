...
# Image paths
image_paths = sorted(glob('/Users/brettmorris/git/tic224283342/data/minerva_20190817/MDwarf-*z45.fit'))[113:]
...
star_positions = np.loadtxt('outputs/minerva2.reg')
output_path = 'outputs/minerva_z2.npz'
...
np.save('outputs/minerva_z2.npy', np.vstack([phot_results.times, best_lc]).T)
