...
# Image paths
image_paths = sorted(glob('/Users/brettmorris/git/tic224283342/data/minerva_20190817/MDwarf-*i45.fit'))[113:]
...
output_path = 'outputs/minerva_i2.npz'
...
np.save('outputs/minerva_i2.npy', np.vstack([phot_results.times, best_lc]).T)
