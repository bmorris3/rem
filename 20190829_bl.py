...
# Image paths
image_paths = sorted(glob('/Users/brettmorris/data/rem/20190829/IMG*BL*.fits'))
...
star_positions = [[594, 661],
                  [318, 618]]
output_path = 'outputs/20190829bl.npz'
...
np.save('outputs/20190829_z.npy', best_lc)
