...
# Image paths
image_paths = sorted(glob('/Users/brettmorris/data/rem/20190829/IMG*UR*.fits'))[:-40]
master_flat_path = 'outputs/master_flat_s_201906_UR_g_1s_norm.fits'
master_dark_path = 'outputs/masterdark_ur.fits'
...
star_positions = [[546, 675],
                  [757, 640]]
output_path = 'outputs/20190829ur.npz'
